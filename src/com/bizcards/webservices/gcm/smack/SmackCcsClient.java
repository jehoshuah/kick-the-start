...
public class SmackCcsClient {
    ...
    public Packet toPacket() {
      return new Message() {
        ...
        public String toXML() {
          ...
          if (getPacketID() != null) {
            buf.append(" username=\"").append(getPacketID()).append("\"");
          }
          if (getTo() != null) {
  ...
  /**
   * Returns a random message username to uniquely identify a message.
   *
   * <p>Note:
  ...
  public static String createJsonMessage(String to, String messageId, Map<String, String> payload,
    ...
    return CommonJsonBuilder.getJsonForEntity(message);
  }
...
//          
          ...
          Map<String, Object> jsonObject = new Gson().fromJson(json, type);
